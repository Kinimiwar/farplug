...
!ifdef bundle
  ...
  light -nologo -ext WixUIExtension -cultures:en-us -spdb -sval -dcl:high -dWixUIBannerBmp=installer\bundle-banner.bmp -dWixUIDialogBmp=installer\bundle-dialog.bmp -out far_$(version)$(distrsuffix)_bundle.msi installer.wixobj MyWixUI_FeatureTree.wixobj
!else
