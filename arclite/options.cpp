...
void Options::load() {
  ...
  handle_create = get_bool(c_param_handle_create, c_def_handle_create);
  handle_commands = get_bool(c_param_handle_commands, c_def_handle_commands);
  ...
  extract_separate_dir = get_int(c_param_extract_separate_dir, c_def_extract_separate_dir);
  ...
  update_show_password = get_bool(c_param_update_show_password, c_def_update_show_password);
  ...
  update_volume_size = get_str(c_param_update_volume_size, c_def_update_volume_size);
...
void Options::save() {
  ...
  set_bool(c_param_handle_create, handle_create, c_def_handle_create);
  set_bool(c_param_handle_commands, handle_commands, c_def_handle_commands);
  ...
  set_int(c_param_extract_separate_dir, extract_separate_dir, c_def_extract_separate_dir);
  ...
  set_bool(c_param_update_show_password, update_show_password, c_def_update_show_password);
  ...
  set_str(c_param_update_volume_size, update_volume_size, c_def_update_volume_size);
